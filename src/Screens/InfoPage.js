      ...
      <section>
        ...
        <div className=" my-20">
          <div className='place-content-center'>
            ...
            <p className='text-xl lg:text-2xl sm:text-2xl'>Built by <br></br> <a href='https://github.com/Aditya2Mathur' className='text-skin-base underline'>Aditya Kumar Mathur</a>.</p>
          </div>
        </div>
      </section>
    </div>
